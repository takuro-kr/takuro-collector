...
현재 개발 버전은 KIN·AMB 안정화, AMM 지원, 목록 정렬, AMB 4개 현 discovery·기존 매물 재수집 생략과 서명형 자동 updater를 포함한 `0.4.6`입니다. 위 ZIP/EXE 해시는 수정 전 0.4.0 배포 기준선의 식별값입니다.

0.4.3 이후 빌드 식별값은 각 release 문서에 기록합니다. 0.4.6 결과는 `docs/releases/0.4.6.md`에 기록합니다.
